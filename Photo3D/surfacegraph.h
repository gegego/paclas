...
public:
    ...
    void importImage(QImage img);
    void importFilter(QImage filter);
...
private:
    ...
    QHeightMapSurfaceDataProxy *m_filterProxy;
    QSurface3DSeries *m_filterSeries;

    QHeightMapSurfaceDataProxy *m_resultProxy;
    QSurface3DSeries *m_resultSeries;
